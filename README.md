...
and republish its image. Retrying the newest GitHub Release also restores
`:latest`; retrying an older release does not move `:latest`, preventing a
rollback for deployments that follow that tag.
